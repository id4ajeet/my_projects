...
--create sequence call_data_id_seq as integer;
alter sequence call_data_id_seq owner to ajeet;
...
--create sequence sync_data_id_seq as integer;
alter sequence sync_data_id_seq owner to ajeet;
